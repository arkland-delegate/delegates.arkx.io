...
class RankShifted extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
            ->line('Attention! The winds of change are blowing, and ranks for '.$this->delegate->username.' have shifted. Please follow the link to see how your payout might be affected.')
